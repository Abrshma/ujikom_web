<!-- resources/views/admin/galery/create.blade.php -->
@extends('layouts.app')

@section('content')
    <div class="container mx-auto p-6">
        <h2 class="text-2xl font-semibold text-gray-700 mb-4">Tambah Galeri</h2>
        ...
        <form action="{{ route('admin.galery.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="position" id="position" value="{{ old('position') }}" required class="w-full p-3 border border-gray-300 rounded">
            </div>
            ...
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Simpan Galeri</button>
