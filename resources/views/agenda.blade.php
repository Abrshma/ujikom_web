...
<head>
    ...
    <style>
        ...
        .card:hover {
            transform: scale(1.05); /* Memperbesar card sedikit saat di-hover */
...
<body>
    ...
    <div class="container mt-5 slide-in-up">
        <h1 class="text-center">Agenda Sekolah</h1>
        <br>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-3 slide-in-up">
                            <div class="card-body">
                                ...
                                <a href="{{ route('agenda.detail', $post->id) }}" class="btn btn-primary">Selengkapnya</a>
                            </div>
                        </div>
                    </div>
                @endforeach
