...
<button onclick="history.back()" class="btn btn-primary mb-4">Kembali</button>
    <div class="card mb-3">
        <div class="card-body">
            <img src="{{ asset('storage/images/PPLG.jpg') }}" alt="Thumbnail">
            <div>
                <h5 class="card-title">Pengembangan Perangkat Lunak dan Gim</h5>
                <p class="card-text">Pengembangan Perangkat Lunak dan Gim merupakan kompetensi keahlian yang awal mulanya bernama Rekayasa Perangkat Lunak (RPL). Sesuai dengan namanya, keahlian yang dipelajari pada kompetensi ini pun berkisar seputar pembuatan perangkat lunak (software) dan pembuatan gim.</p>
            </div>
        </div>
    </div>
</div>
