...
<button onclick="history.back()" class="btn btn-primary mb-4">Kembali</button>
    <div class="card mb-3">
        <div class="card-body">
            <img src="{{ asset('storage/images/TFLM.jpg') }}" alt="Thumbnail">
            <div>
                <h5 class="card-title">Teknik Pengelasan dan Fabrikasi Logam</h5>
                <p class="card-text">Teknik Pengelasan dan Fabrikasi Logam, merupakan jurusan yang di dominasi oleh kaum laki-laki. Seperti namanya, kompetensi keahlian ini berfokus pada pembuatan perangkat dengan menggunakan bahan dasar logam, seperti halnya rak sepatu, tralis, lemari besi, dan lain sebagainya.</p>
            </div>
        </div>
    </div>
</div>
